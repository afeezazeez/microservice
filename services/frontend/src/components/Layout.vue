      ...
      <header class="h-16 bg-[var(--color-bg-elevated)] border-b border-[var(--color-border)] flex items-center justify-between px-4 lg:px-6">
        ...
        <div class="flex items-center gap-4 relative">
          <button
            ...
            class="notification-icon-button relative p-2 text-zinc-400 hover:text-white rounded-lg hover:bg-zinc-800 transition-colors cursor-pointer"
          ...
          <NotificationDropdown v-model="showNotificationDropdown" />
        </div>
      </header>
